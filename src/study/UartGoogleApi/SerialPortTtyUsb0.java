...
public class SerialPortTtyUsb0 {
	...
	public SerialPortTtyUsb0(Handler handler, Context context) {
	...
	public void openDevice() {
		try {
			mSerialPort = mApplication.getSerialPortTtyUsb0();
		...
		public void run() {
			...
			while(!isInterrupted()) {
				...
				try {
					...
					if (size > 0) {
						Log.d("debug", "SerialPortTtyUsb0: " + byte2HexStr(buffer, size));
					}
				} catch (IOException e) {
					e.printStackTrace();
					return;
